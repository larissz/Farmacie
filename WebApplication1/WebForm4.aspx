    ...
    <form id="form1" runat="server">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href='/WebForm4.aspx'>Products</a>
                            </li>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div align="center">
                    <asp:Label ID="SelectIDLabel" runat="server" Text="Selectati id ul corespunzator locatiei " /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:DropDownList ID="IDLocatie" runat="server" width="5%" style="text-align: center" OnSelectedIndexChanged="IDLocatie_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                    <br /><br /><br />
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonVitaminaB" runat="server" Text="+" OnClick="ButonVitaminaB2_Click" /><br />
                                <asp:Button ID="ButtonCheckVitaminaB" runat="server" Text="Verificare" OnClick="ButonVitaminaBCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonVitaminaAD" runat="server" Text="+" OnClick="ButonVitaminaAD2_Click" /><br />
                                <asp:Button ID="ButtonCheckVitaminaAD" runat="server" Text="Verificare" OnClick="ButonVitaminaADCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonVitaminaK" runat="server" Text="+" OnClick="ButonVitaminaK2_Click" /><br />
                                <asp:Button ID="ButtonVitaminaKCheck" runat="server" Text="Verificare" OnClick="ButonVitaminaKCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonSirop" runat="server" Text="+" OnClick="ButonSirop2_Click" /><br />
                                <asp:Button ID="ButtonCheckSiropTuse" runat="server" Text="Verificare" OnClick="ButonSiropTuseCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Label ID="LabelApaTermala" runat="server" Text="Numar Produse" Font-Bold="True"></asp:Label>
                                 <asp:Button ID="ButtonApaTermala" runat="server" Text="+" OnClick="ButonApaTermala2_Click" /><br />
                                <asp:Button ID="ButtonCheckApaTermala" runat="server" Text="Verificare" OnClick="ButonApaTermalaCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonBalsam" runat="server" Text="+" OnClick="ButonBalsam2_Click" /><br />
                                <asp:Button ID="ButtonCheckBalsam" runat="server" Text="Verificare" OnClick="ButonBalsamCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonParacetamol" runat="server" Text="+" OnClick="ButonParacetamol2_Click" /><br />
                                <asp:Button ID="ButtonCheckParacetamol" runat="server" Text="Verificare" OnClick="ButonParacetamolCheck_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" align="center">
                                ...
                                <asp:Button ID="ButtonOmega3" runat="server" Text="+" OnClick="ButonOmega32_Click" /><br />
                                <asp:Button ID="ButtonCheckOmega" runat="server" Text="Verificare" OnClick="ButonOmegaCheck_Click" />
                            </div>
                        </div>
                    </div>
                </div>
