    ...
    <Columns>
        ...
        <selectedrowstyle backcolor="#000000"
         ...
         font-bold="true"/>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <asp:Button Width="49%" ID="ButonCautare" runat="server" Text="Cautare" OnClick="ButonCautare_Click" />
                        <asp:TextBox Width="49%" ID="TextBoxCautare" Columns="10" MaxLength="20" Text="" runat="server"/>
                    </div>
                </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <!-- Product actions-->
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <asp:Button Width="100%" ID="ButonAdauga" runat="server" Text="Adaugare" OnClick="ButonAdauga_Click" />
                    </div>
                </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <!-- Product actions-->
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <asp:Button Width="100%" ID="ButonEditeaza" runat="server" Text="Editare" OnClick="ButonEditeaza_Click" />
                    </div>
                </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <!-- Product actions-->
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <asp:Button Width="100%"  ID="ButonSterge" runat="server" Text="Stergere" OnClick="ButonSterge_Click" />
                    </div>
                </div>
